...
public class PosItemLogDTO implements Serializable {
    ...
    public static PosItemLogDTO get(List<PosItemLogDTO> posItemLogs, Integer itemNum, Integer posItemLogItemMatrixNum, String posItemLogLotNumber) {
        ...
        for(int i = 0;i < posItemLogs.size();i++){
            PosItemLogDTO posItemLog = posItemLogs.get(i);
