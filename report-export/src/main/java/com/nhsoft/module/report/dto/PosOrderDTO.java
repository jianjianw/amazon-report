 ...
 */
public class PosOrderDTO implements java.io.Serializable {

	private static final Logger logger = LoggerFactory.getLogger(PosOrderDTO.class);
	...
	private List<PosOrderDetailDTO> posOrderDetails = new ArrayList<PosOrderDetailDTO>(0);
	private List<PaymentDTO> payments = new ArrayList<PaymentDTO>(0);
	private List<InvoiceChangeDTO> invoiceChanges = new ArrayList<InvoiceChangeDTO>();
	...
	public List<PosOrderDetailDTO> getPosOrderDetails() {
		return posOrderDetails;
	}

	public void setPosOrderDetails(List<PosOrderDetailDTO> posOrderDetails) {
	...
	public List<InvoiceChangeDTO> getInvoiceChanges() {
		return invoiceChanges;
	}

	public void setInvoiceChanges(List<InvoiceChangeDTO> invoiceChanges) {
	...
	public static PosOrderDTO readFromXml(String text){
		PosOrderDTO posOrder = new PosOrderDTO();
		try {
			...
			if(element != null){
				...
				if(node != null){
					posOrder.setPosOrderDetails(PosOrderDetailDTO.readFromNode(node));
				}
				
				node = (Element) element.selectSingleNode("PAYMENT_LIST");
				if(node != null){
					posOrder.setPayments(PaymentDTO.readFromNode(node));
				}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PosOrderDTO other = (PosOrderDTO) obj;
		if (orderNo == null) {
