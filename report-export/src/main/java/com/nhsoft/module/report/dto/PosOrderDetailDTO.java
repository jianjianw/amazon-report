...
public class PosOrderDetailDTO implements java.io.Serializable {
	...
	private List<PosOrderKitDetailDTO> posOrderKitDetails = new ArrayList<PosOrderKitDetailDTO>();
	...
	public List<PosOrderKitDetailDTO> getPosOrderKitDetails() {
		return posOrderKitDetails;
	}

	public void setPosOrderKitDetails(List<PosOrderKitDetailDTO> posOrderKitDetails) {
	...
	public static List<PosOrderDetailDTO> readFromNode(Element root){
		List<PosOrderDetailDTO> posOrderDetails = new ArrayList<PosOrderDetailDTO>();
		Iterator<Element> iterator = root.elementIterator("POS_ORDER_DETAIL");
		while(iterator.hasNext()){
			Element element = iterator.next();
			PosOrderDetailDTO detail = new PosOrderDetailDTO();
			...
			if(node != null){
				detail.setPosOrderKitDetails(PosOrderKitDetailDTO.readFromNode(node));
			}
	...
	public static List<PosOrderDetailDTO> find(
            List<PosOrderDetailDTO> posOrderDetails, String orderNo) {
	    List<PosOrderDetailDTO> list = new ArrayList<PosOrderDetailDTO>();
	    for(int i = 0;i < posOrderDetails.size();i++){
	    	PosOrderDetailDTO posOrderDetail = posOrderDetails.get(i);
	    	if(posOrderDetail.getOrderNo().equals(orderNo)){
