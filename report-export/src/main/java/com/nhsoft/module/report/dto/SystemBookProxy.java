...
public class SystemBookProxy implements java.io.Serializable {
	...
	private Date bookProxyTempChannelExpire;
	...
	public Date getBookProxyTempChannelExpire() {
		return bookProxyTempChannelExpire;
	}

	public void setBookProxyTempChannelExpire(Date bookProxyTempChannelExpire) {
	...
	public String getCardUrl() {
		String url = null;
		 if(bookProxyRegion != null && (bookProxyRegion.equals("青岛")|| bookProxyRemoteServer.equals("139.129.96.247"))){
			if(StringUtils.isEmpty(bookProxyCardRemoteServer)){
				url = bookProxyRemoteServer;
			} else {
				url = bookProxyCardRemoteServer;
			}
		} else {
			if(StringUtils.isEmpty(bookProxyCardServer)){
				url = bookProxyServer;
			} else {
				url = bookProxyCardServer;
			}
		}
		return "http://" + url + ":" + bookProxyPort + "/"
				+ bookProxyPath + "/remoting/";
	...
	public String getSynchUrl() {
		String url = null;
		 if(bookProxyRegion != null && (bookProxyRegion.equals("青岛")|| bookProxyRemoteServer.equals("139.129.96.247"))){
			if(StringUtils.isEmpty(bookProxySynchRemoteServer)){
				url = bookProxyRemoteServer;
			} else {
				url = bookProxySynchRemoteServer;
			}
		} else {
			if(StringUtils.isEmpty(bookProxySynchServer)){
				url = bookProxyServer;
			} else {
				url = bookProxySynchServer;
			}
		}
		return "http://" + url + ":" + bookProxyPort + "/"
				+ bookProxyPath + "/remoting/";
