...
public interface RetailPosLogDao {
	...
	public List<RetailPosLog> findByQuery(String systemBookCode,
										  Integer branchNum, Integer stallNum, LogQuery queryCondition,
										  Integer offset, Integer limit);
	 ...
	 * @return
	 */
	public List<Object[]> findTypeCountAndMoney(String systemBookCode, Integer branchNum, List<Integer> stallNums, Date dateFrom,
												Date dateTo, String logTypes);
