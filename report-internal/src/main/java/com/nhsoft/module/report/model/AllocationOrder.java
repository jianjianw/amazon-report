...
public class AllocationOrder implements java.io.Serializable {
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="allocationOrderStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="allocationOrderStateName")) } )
	private State state;
	...
	@JoinColumn(name = "allocationOrderFid", updatable=false, insertable=false)
