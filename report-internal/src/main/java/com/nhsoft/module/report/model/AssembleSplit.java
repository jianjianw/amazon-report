...
public class AssembleSplit implements java.io.Serializable {
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="assembleSplitStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="assembleSplitStateName")) } )
	private State state;
	...
	@JoinColumn(name = "assembleSplitFid", updatable=false, insertable=false)
