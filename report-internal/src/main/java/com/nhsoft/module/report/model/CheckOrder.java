...
public class CheckOrder implements java.io.Serializable {
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="checkOrderStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="checkOrderStateName")) } )
	private State state;
	...
	@JoinColumn(name = "checkOrderFid", updatable=false, insertable=false)
