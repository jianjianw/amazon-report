...
public class ClientSettlement implements java.io.Serializable {
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="clientSettlementStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="clientSettlementStateName")) } )
	private State state;
	...
	@JoinColumn(name = "clientSettlementNo", updatable=false, insertable=false)
