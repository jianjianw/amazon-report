 ...
 */
@Entity
public class GroupCustomerStatistics implements java.io.Serializable {
	...
	public GroupCustomerStatistics() {
	...
	public static GroupCustomerStatistics getGroupCustomerStatistics(String groupCustomerId, List<GroupCustomerStatistics> groupCustomerStatisticses) {
		if(groupCustomerId == null || groupCustomerStatisticses == null) {
			return null;
		}
		for(GroupCustomerStatistics o : groupCustomerStatisticses) {
