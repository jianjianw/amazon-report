...
public class OriCardUser implements java.io.Serializable {
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="cardUserStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="cardUserStateName")) } )
	private State state;
	...
	// 临时属性
	@Column(name = "cardUserNum", insertable = false, updatable = false)
	private Integer cardUserNum;  //jsonRPC传数据用
	@Column(name = "systemBookCode", insertable = false, updatable = false)
