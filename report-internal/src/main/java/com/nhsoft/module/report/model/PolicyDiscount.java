...
public class PolicyDiscount implements java.io.Serializable {
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="policyDiscountStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="policyDiscountStateName")) } )
	private State state;
	...
	@JoinColumn(name = "policyDiscountNo", updatable=false, insertable=false)
