...
//		String timeFrom = DateUtil.getHHmmStr(policyPromotionTimeFrom);
//		String timeTo = DateUtil.getHHmmStr(policyPromotionTimeTo);
//		String nowStr = DateUtil.getHHmmStr(now);
//		if(timeFrom.compareTo(nowStr) > 0){
//			return false;
//		}
//		if(timeTo.compareTo(nowStr) < 0){
//			return false;
//		}
		return true;
	}
