...
public class PosClient implements java.io.Serializable {
	...
	@Column(name = "clientTax1_Exemption")
	private boolean clientTax1Exemption;
	@Column(name = "clientTax2_Exemption")
	...
	public static PosClient getPosClient(String posClientFid, List<PosClient> posClientList) {
		return posClientList.stream().filter(p -> p.getClientFid().equals(posClientFid)).findFirst().orElse(null);
	}
