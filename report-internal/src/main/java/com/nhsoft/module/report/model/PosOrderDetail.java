...
public class PosOrderDetail implements java.io.Serializable {
	...
	@OneToMany
	@JoinColumns({@JoinColumn(name = "orderNo", referencedColumnName = "orderNo", insertable = false, updatable = false), @JoinColumn(name="orderDetailNum", referencedColumnName = "orderDetailNum", insertable = false, updatable = false)})
