...
public class PreSettlement implements java.io.Serializable {
	...
	@JoinTable(name="PreSelfSettlementDetail", joinColumns={@JoinColumn(name="preSettlementNo")}, inverseJoinColumns={@JoinColumn(name="purchaseOrderFid", referencedColumnName="purchaseOrderFid")})
