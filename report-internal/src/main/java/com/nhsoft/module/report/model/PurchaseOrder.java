...
public class PurchaseOrder implements java.io.Serializable {
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="purchaseOrderStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="purchaseOrderStateName")) } )
	private State state;
	...
	@JoinColumn(name = "purchaseOrderFid", updatable=false, insertable=false)
	private List<PurchaseOrderDetail> purchaseOrderDetails = new ArrayList<PurchaseOrderDetail>(0);
	@ManyToMany
	@Fetch(FetchMode.SUBSELECT)
	@JoinTable(name="RequestOrderPurchaseOrder", joinColumns={@JoinColumn(name="purchaseOrderFid")}, inverseJoinColumns={@JoinColumn(name="requestOrderFid", referencedColumnName="requestOrderFid")})
