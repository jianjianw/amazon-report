...
public class TaskRequest implements java.io.Serializable {
	...
	private BigDecimal taskRequestPickQty;
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="taskRequestStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="taskRequestStateName")) } )
	private State state;
	@OneToMany
	@Fetch(FetchMode.SUBSELECT)
	@JoinColumn(name = "taskRequestFid", updatable=false, insertable=false)
