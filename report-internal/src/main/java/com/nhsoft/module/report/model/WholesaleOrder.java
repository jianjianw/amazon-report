...
public class WholesaleOrder implements java.io.Serializable {
	...
	@Embedded
	@AttributeOverrides( {
		 			@AttributeOverride(name="stateCode", column = @Column(name="wholesaleOrderStateCode")), 
		@AttributeOverride(name="stateName", column = @Column(name="wholesaleOrderStateName")) } )
	private State state;
	...
	@JoinColumn(name = "wholesaleOrderFid", updatable=false, insertable=false)
