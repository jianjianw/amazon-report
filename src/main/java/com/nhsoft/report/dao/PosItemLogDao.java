...
import com.nhsoft.report.model.Inventory;
import com.nhsoft.report.model.OrderTaskDetail;
import com.nhsoft.report.model.PosItemLog;
import com.nhsoft.report.shared.queryBuilder.StoreQueryCondition;
...
public interface PosItemLogDao {
	...
	public int countByStoreQueryCondition(StoreQueryCondition storeQueryCondition);
	 ...
	 * 查询商品最后收货日期
	 * @param systemBookCode
	 * @param requestOrderOutBranchNum
	 * @return
	 */
	public List<Object[]> findItemLastReceiveDate(String systemBookCode,
                                                  Integer requestOrderOutBranchNum);
	 ...
	 * @return
	 */
	public BigDecimal getItemAmount(String systemBookCode, Integer branchNum, Date dateFrom, Date dateTo, Integer itemNum, Boolean inoutFlag);
	 ...
	 * @return
	 */
	public Integer batchDelete(String systemBookCode, Integer branchNum, Date limitDate, int batchSize);
	 ...
	 * @return
	 */
	public Integer batchDelete(Date limitDate, int batchSize);
