...
public class AlipayLogDaoImpl extends DaoImpl implements AlipayLogDao {
	...
	private StringBuffer _createByLogQuery(String systemBookCode, Integer branchNum, LogQuery logQuery){
	...
	public int _countByLogQuery(String systemBookCode, Integer branchNum, LogQuery logQuery){
		StringBuffer sb = _createByLogQuery(systemBookCode, branchNum, logQuery);
		SQLQuery sqlQuery = currentSession().createSQLQuery(sb.toString());
	...
	public List<AlipayLog> _findByLogQuery(String systemBookCode, Integer branchNum, LogQuery logQuery, int offset,
										  int limit) {
	...
	public List<Object[]> _findBranchSummaryPayFail(String systemBookCode, List<Integer> branchNums, Date dateFrom,
													Date dateTo, boolean isDeposit, String alipayLogTypes){
	...
	public List<Object[]> _findBranchSummaryRePay(String systemBookCode, List<Integer> branchNums, Date dateFrom,
												  Date dateTo, String alipayLogTypes) {
	...
	public List<AlipayDetailDTO> _findAlipayDetailDTOs(String systemBookCode, List<Integer> branchNums, Date dateFrom,
													   Date dateTo, String orderNoPres, String alipayLogTypes){
		StringBuffer sb = new StringBuffer();
	...
	public List<AlipayDetailDTO> _findCancelAlipayDetailDTOs(String systemBookCode, List<Integer> branchNums,
															 Date dateFrom, Date dateTo, String orderNoPres, String alipayLogTypes){
		StringBuffer sb = new StringBuffer();
		sb.append("select alipay_log_trade_no,alipay_log_order_no,branch_num," +
				"alipay_log_start,alipay_log_buyer_id,alipay_log_money,alipay_log_receipt_money,alipay_log_buyer_money from alipay_log where ");
	...
	public List<Object[]> _findDepositSummary(String systemBookCode, List<Integer> branchNums, Date dateFrom, Date dateTo, String alipayLogTypes){
		StringBuffer sb = new StringBuffer();
