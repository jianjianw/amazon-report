...
public class CenterProfitByPosItem implements Serializable {
	...
	private Integer branchNum;        			//调往分店编号
	private String branchName;        			//调往分店名称
