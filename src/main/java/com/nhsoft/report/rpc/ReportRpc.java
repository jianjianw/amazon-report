...
public interface ReportRpc {
	 ...
	 * @return
	 */
	List<PosItemRank> findPosItemRanks(String systemBookCode, Integer branchNum, Date dateFrom, Date dateTo, List<PosItem> posItems);
	 ...
	 * @return
	 */
	List<Object[]> findPosGroupByHourAndBranchRegionType(String systemBookCode, Integer branchNum, Date dateFrom, Date dateTo);
	 ...
	 * @return
	 */
	List<ReportDTO> findReportDTOs(ReportDTO queryReportDTO, CustomReport customReport);
	 ...
	 * @return
	 */
	List<InventoryAnalysisDTO> findInventoryAnalysiss(InventoryAnalysisQuery inventoryAnalysisQuery, ChainDeliveryParam chainDeliveryParam);
